...
- (Todo) 大きめの変更点 2 を書く
 ...
 [新しい利用規約](https://github.com/shiguredo/sora-labo-doc/blob/master/TERMS.md) はこちらからご確認ください
...
- Sora Labo は商用目的で利用できますか？
  - 商用目的では利用できません
  - Sora Labo は Sora および Sora Cloud の検証以外の目的や用途では利用できません
  - 商用目的で利用する場合は Sora の本番環境用ライセンス、または Sora Cloud を契約してください
- Sora Labo を商用サービスや商用製品の開発のために利用できますか？
  - 商用製品の開発では利用できません
  - 商用製品やサービスの開発のために利用する場合は Sora の開発環境用ライセンス、または Sora Cloud を契約してください
- Sora Labo は不特定多数の人に向けて利用できますか？
  - 不特定多数向けのサービスや製品には利用できません
  - Sora Labo は Sora および Sora Cloud の検証以外の目的や用途では利用できません
- Sora Labo は法人や団体で利用できますか？
  - 利用可能ですが、Sora および Sora Cloud の検証目的でのみご利用いただけます
