...
- 制限解除申請なしでの 1 接続の連続接続時間は 60 分です

  - 制限解除した場合の 1 接続の連続接続時間は無制限になります
- 制限解除申請なしでの最大合計接続時間は 1000 分です
...
Sora Labo は商用利用は許可しておりません、
また個人事業主やアカデミックでの利用は制限解除に対応しておりませんので、以下をご検討ください。
