...
- 認証エラー理由に ``PLEASE-CONTACT-US`` が出ました
  ...
  - どれかの禁止事項に当てはまっている可能性がある場合に出ます、ご連絡ください
...
**基本的には開発版ライセンスのご利用をお願いいたします**

Sora のライセンスを契約頂いている方も申請をお願いします。
申請可能な GitHub アカウントは最大 2 名までです。利用期限はライセンスを契約頂いている間になります。

サポートメールアドレスまで **利用する GitHub アカウント** をお送りください。
