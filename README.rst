...
- 法人、個人事業主での利用でも申請が不要になりました
- アカデミックでの利用を禁止しました
- 利用制限を解除するための申請が必要になりました
...
- Sora Labo は法人や個人事業主で利用できますか？
  ...
  - Sora の検証目的でのみご利用いただけます
- Sora Labo はアカデミックで利用できますか？

  - Sora Labo はアカデミックでの利用はできません。もし利用する場合は評価版を検討してください。
...
- Sora Labo の合計接続時間制限はありますか？
  ...
  - 制限解除申請前は 100 分です
  - 制限解除申請前で GitHub アカウントが作りたての場合は 10 分です
  - 制限解除申請後は無制限です
...
法人、または個人事業主の方で利用制限を解除する場合は下記の必要事項を記入の上 sora-labo at shiguredo.jp までお送りください。
...
Sora Labo は商用利用や学術利用は許可しておりませんので、以下をご検討ください。
