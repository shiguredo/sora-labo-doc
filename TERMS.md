...
本サービス提供に際してリンクされた他のウェブサイト、アプリケーションその他のサービス（以下、本サービスの提供に際してリンクされた他のウェブサイト、アプリケーションその他のサービスを総称して「外部サービス等」といいます。）については、サービスサイト、外部サービス等に定められる利用規約及び [プライバシーポリシー](https://shiguredo.jp/pdf/privacy.pdf）等に従ってご利用いただきますようお願い致します。
