...
1. 本サービスは、当社が提供する「WebRTC SFU Sora」又は「Sora Cloud」の検証及び WebRTC の技術そのものに関心のある個人の方の技術的な理解を目的としてのみを目的として無償で提供されるものであり、ユーザーはそれ以外の目的で本サービスを利用することはできません。そのため、ユーザーは、例えば以下の各号の方法で、本サービスを利用することはできません。
