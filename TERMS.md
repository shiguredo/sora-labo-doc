...
本サービスは、以下のような方のためにご提供しています。

1. 「WebRTC Sora」や「Sora Cloud」の導入を検討されている法人や団体の技術担当者様
2. WebRTC の技術そのものに関心のある個人の方

本サービスの利用を希望される方は、本規約を遵守することに同意し、当社の定める方法（GitHub アカウントを用いた OAuth 認証）でユーザー登録することにより、本サービスのユーザーとなることができます。ただし、以下の各号のいずれかに該当する場合にはユーザー登録をすることはできず、これらのいずれかに該当していることが判明した場合には、当社は、第 19 条により、ユーザーのアカウントを削除することができるものとします。

1. 本サービスの利用について、過去にアカウント削除等の本サービス利用停止措置（第19 条で定義します）を受けたことがあり又は現在受けている場合
...
1. 本サービスは、当社が提供する「WebRTC SFU Sora」又は「Sora Cloud」の検証のみを目的として無償で提供されるものであり、ユーザーはそれ以外の目的で本サービスを利用することはできません。そのため、ユーザーは、例えば以下の各号の方法で、本サービスを利用することはできません。
   1. 有償・無償を問わず、第三者に対してサービスを提供することを目的として、本サービスを利用すること
   2. 自己の組織内のみでの利用であっても、実際の業務運営のための環境（本番環境）で本サービスを利用すること

2. 本サービスは、Sora Labo ドキュメント及び Sora Labo コミュニティに記載された利用方法にしたがい、Sora Labo ドキュメント及び Sora Labo コミュニティに記載された制限範囲内でのみ利用することができます。ユーザーは、本サービスの利用に当たり、Sora Labo ドキュメント及び Sora Labo コミュニティを必ず確認しなければいけません。当社は、Sora Labo ドキュメント及び Sora Labo コミュニティの内容を、事前の通知なく変更することができるものとし、ユーザーは最新の内容を遵守しなければならないものとします。なお、Sora Labo ドキュメント、Sora Labo コミュニティ、本規約間に相違がある場合には、Sora Labo コミュニティ、Sora Labo ドキュメント、本規約の順番で優先するものとします。
...
1. 当社によるユーザーに関する情報の取扱いについては、別途定めるプライバシーポリシーによるものとし、ユーザーは、プライバシーポリシーに従って当社が当該情報を取り扱うことについて同意するものとします。
